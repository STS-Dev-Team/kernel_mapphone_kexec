...
/**
 * struct hsi_error_stats - HSI error statistics
 *@ signal_errors: Signal Error
 *@ frame_timeout_errors: Frame Timeout Error
 *@ tailing_bit_errors: Tailing Bit Error
 *@ rx_mapping_errors: RX Mapping Error
 *@ tx_mapping_errors: TX Mapping Error
*/

struct hsi_error_stats {
	unsigned long  signal_errors;
	unsigned long  frame_timeout_errors;
	unsigned long  tailing_bit_errors;
	unsigned long  rx_mapping_errors;
	unsigned long  tx_mapping_errors;
};
 ...
 * @error_stats: port error statistics
 */
struct hsi_port {
	...
	struct tasklet_struct cawake_tasklet;	/* SSI_TODO : need to replace */
						/* by a workqueue */
	struct hsi_error_stats error_stats;
};
