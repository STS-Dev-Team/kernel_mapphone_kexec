				      ...
				      size_t count, loff_t *offp)
{
	...
	sprintf(tmp_str, "Signal Error: %ld\n",
			hsi_port->error_stats.signal_errors);
	strcat(str, tmp_str);
	sprintf(tmp_str, "Frame Timeout Error: %ld\n",
			hsi_port->error_stats.frame_timeout_errors);
	strcat(str, tmp_str);
	sprintf(tmp_str, "Tailing Bit Error: %ld\n",
			hsi_port->error_stats.tailing_bit_errors);
	strcat(str, tmp_str);
	sprintf(tmp_str, "RX Mapping Error: %ld\n",
			hsi_port->error_stats.rx_mapping_errors);
	strcat(str, tmp_str);
	sprintf(tmp_str, "TX Mapping Error: %ld\n",
			hsi_port->error_stats.tx_mapping_errors);
	strcat(str, tmp_str);
