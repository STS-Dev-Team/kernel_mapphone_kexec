...
static struct omap_uart_port_info omap_serial_platform_data[] = {
	{
		...
		.rts_override	= 0,
		.cts_padconf	= 0,
		.cts_padconf_mode = -1,		/* Invalid Mode */
	...
	},
	{
		...
		.cts_padconf_mode = OMAP_MUX_MODE0, /* CTS signal in MOde 0 */
...
static void __init omap_4430sdp_init(void)
{
	...
	if (!strcmp(modem_ipc, "hsi")) {
		...
		outl(0x101, OMAP4430_CM_L4PER_GPIO3_CLKCTRL);
		outl(inl(OMAP2_L4_IO_ADDRESS(OMAP4_GPIO3_BASE + OMAP4_GPIO_CTRL)) & 0xFFFFFFFE,
			 OMAP2_L4_IO_ADDRESS(OMAP4_GPIO3_BASE + OMAP4_GPIO_CTRL));

		/*set SERVICEn (GPIO 92) to output and set it to 0*/
		outl(inl(OMAP2_L4_IO_ADDRESS(OMAP4_GPIO3_BASE + OMAP4_GPIO_OE)) & 0xEFFFFFFF,
			 OMAP2_L4_IO_ADDRESS(OMAP4_GPIO3_BASE + OMAP4_GPIO_OE));
		outl(inl(OMAP2_L4_IO_ADDRESS(OMAP4_GPIO3_BASE + OMAP4_GPIO_DATAOUT)) & 0xEFFFFFFF,
			 OMAP2_L4_IO_ADDRESS(OMAP4_GPIO3_BASE + OMAP4_GPIO_DATAOUT));

		/* Enable GPIO6 Clock and Enable module*/
		outl(0x101, OMAP4430_CM_L4PER_GPIO6_CLKCTRL);
		outl(inl(OMAP2_L4_IO_ADDRESS(OMAP4_GPIO6_BASE + OMAP4_GPIO_CTRL)) & 0xFFFFFFFE,
			 OMAP2_L4_IO_ADDRESS(OMAP4_GPIO6_BASE + OMAP4_GPIO_CTRL));

		/* Set ONSWA (GPIO 187) set output enable and set it to 0 */
		outl(inl(OMAP2_L4_IO_ADDRESS(OMAP4_GPIO6_BASE + OMAP4_GPIO_OE)) & 0xF7FFFFFF,
			 OMAP2_L4_IO_ADDRESS(OMAP4_GPIO6_BASE + OMAP4_GPIO_OE));
		outl(inl(OMAP2_L4_IO_ADDRESS(OMAP4_GPIO6_BASE +  OMAP4_GPIO_DATAOUT)) & 0xF7FFFFFF,
			 OMAP2_L4_IO_ADDRESS(OMAP4_GPIO6_BASE +  OMAP4_GPIO_DATAOUT));
