...
static struct mdm6600_ctrl_platform_data mdm6600_ctrl_platform_data = {
	...
	.gpios[MDM_CTRL_GPIO_AP_STATUS_0] = {
		0, MDM_GPIO_DIRECTION_OUT, MDM6600_GPIO_INVALID, 0,
		"mdm_ap_status0"},
	...
	.gpios[MDM_CTRL_GPIO_BP_STATUS_0] = {
		0, MDM_GPIO_DIRECTION_IN, 0, 0, "mdm_bp_status0"},
	.gpios[MDM_CTRL_GPIO_BP_STATUS_1] = {
		0, MDM_GPIO_DIRECTION_IN, 0, 0, "mdm_bp_status1"},
	.gpios[MDM_CTRL_GPIO_BP_STATUS_2] = {
		0, MDM_GPIO_DIRECTION_IN, 0, 0, "mdm_bp_status2"},
	.gpios[MDM_CTRL_GPIO_BP_RESOUT]   = {
		0, MDM_GPIO_DIRECTION_IN, 0, 0, "mdm_bp_resout"},
	.gpios[MDM_CTRL_GPIO_BP_RESIN]    = {
		0, MDM_GPIO_DIRECTION_OUT, 0, 0, "mdm_bp_resin"},
	.gpios[MDM_CTRL_GPIO_BP_PWRON]    = {
		0, MDM_GPIO_DIRECTION_OUT, 0, 0, "mdm_bp_pwr_on"}
};
...
static int mapphone_mdm6600_mdm_ctrl_init(void)
{
	...
	mdm6600_ctrl_platform_data.gpios[MDM_CTRL_GPIO_BP_PWRON].number = gpio;
	...
	mdm6600_ctrl_platform_data.gpios[MDM_CTRL_GPIO_BP_RESOUT].number = gpio;
	...
	mdm6600_ctrl_platform_data.gpios[MDM_CTRL_GPIO_BP_STATUS_0].number =
		gpio;
	...
	mdm6600_ctrl_platform_data.gpios[MDM_CTRL_GPIO_BP_STATUS_1].number =
		 gpio;
	...
	mdm6600_ctrl_platform_data.gpios[MDM_CTRL_GPIO_BP_STATUS_2].number =
		 gpio;
	...
	mdm6600_ctrl_platform_data.gpios[MDM_CTRL_GPIO_AP_STATUS_0].number =
		 gpio;
	...
	mdm6600_ctrl_platform_data.gpios[MDM_CTRL_GPIO_AP_STATUS_1].number =
		 gpio;
	...
	mdm6600_ctrl_platform_data.gpios[MDM_CTRL_GPIO_AP_STATUS_2].number =
		gpio;
	...
	mdm6600_ctrl_platform_data.gpios[MDM_CTRL_GPIO_BP_RESIN].number = gpio;
...
int __init mapphone_mdm_ctrl_init(void)
{
	...
	for (i = 0; i < mapphone_modem.n_modems && ret == 0; ++i) {
		...
		default:
			ret = -ENODEV;
			pr_err("Bad BP %d, Is this a Phone ??", i);
			break;
		}
	}
	return ret;
