...
static inline int __deprecated omap_mux_init_gpio(int gpio, int val)
{
	return 0;
}
static inline int __deprecated omap_mux_init_signal(char *muxname, int val)
{
	return 0;
}
static inline u16 __deprecated omap_mux_read_signal(const char *muxname)
{
	return 0;
}
static inline int __deprecated omap_mux_enable_wakeup(char *muxname)
{
	return 0;
}
static inline int __deprecated omap_mux_disable_wakeup(char *muxname)
{
	return 0;
}
