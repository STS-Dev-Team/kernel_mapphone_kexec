...
static struct omap_opp_def __initdata omap44xx_pre_es2_1_opp_def_list[] = {
	...
	/* IVA OPP1 - OPP50 */
	OMAP_OPP_DEF("iva", true,  132000000, 930000),
	/* IVA OPP2 - OPP100 */
	OMAP_OPP_DEF("iva", true,  265000000, 1100000),
	/* IVA OPP3 - OPP-Turbo */
...
static struct omap_opp_def __initdata omap44xx_opp_def_list[] = {
	...
	/* MPU OPP4 - OPP-SB */
	OMAP_OPP_DEF("mpu", true, 1000000000, 1375000),
	/* IVA OPP1 - OPP50_98 */
	OMAP_OPP_DEF("iva", true,  133000000, 1011000),
	/* IVA OPP1 - OPP50 */
	OMAP_OPP_DEF("iva", true,  132000000, 1013000),
	/* IVA OPP2 - OPP100 */
	OMAP_OPP_DEF("iva", true,  265000000, 1188000),
	/* IVA OPP3 - OPP-Turbo */
	...
	/* L3 OPP2 - OPP100, OPP-Turbo, OPP-SB */
	OMAP_OPP_DEF("l3_main_1", true, 200000000, 1125000),
	/*EMIF1 OPP1 - OPP50 */
	OMAP_OPP_DEF("emif1", true, 400000000, 1025000),
	/*EMIF1 OPP2 - OPP100 */
	OMAP_OPP_DEF("emif1", true, 800000000, 1125000),
	/*EMIF2 OPP1 - OPP50 */
	OMAP_OPP_DEF("emif2", true, 400000000, 1025000),
	/*EMIF2 OPP2 - OPP100 */
	OMAP_OPP_DEF("emif2", true, 800000000, 1125000),
	/* CAM FDIF OPP1 - OPP50 */
	OMAP_OPP_DEF("fdif", true, 64000000, 1025000),
	/* CAM FDIF OPP2 - OPP100 */
	OMAP_OPP_DEF("fdif", true, 128000000, 1125000),
	/* SGX OPP1 - OPP50 */
	OMAP_OPP_DEF("gpu", true, 153600000, 1025000),
	/* SGX OPP2 - OPP100 */
	OMAP_OPP_DEF("gpu", true, 307200000, 1125000),
	/* HSI OPP1 - OPP50 */
	OMAP_OPP_DEF("hsi", true, 96000000, 1025000),
	/* HSI OPP2 - OPP100 */
	OMAP_OPP_DEF("hsi", true, 96000000, 1125000),
};


static struct omap_opp_def __initdata omap44xx_com_opp_def_list[] = {
	/* MPU OPP1 - OPP50 */
	OMAP_OPP_DEF("mpu", true, 300000000, 1025000),
	/* MPU OPP2 - OPP100 */
	OMAP_OPP_DEF("mpu", false, 600000000, 1200000),
	/* MPU OPP3 - OPP-Turbo */
	OMAP_OPP_DEF("mpu", false, 800000000, 1313000),
	/* MPU OPP4 - OPP-SB */
	OMAP_OPP_DEF("mpu", false, 1000000000, 1375000),
	/* IVA OPP1 - OPP50_98 */
	OMAP_OPP_DEF("iva", true,  133000000, 1011000),
	/* IVA OPP1 - OPP50 */
	OMAP_OPP_DEF("iva", true,  132000000, 1013000),
	/* IVA OPP2 - OPP100 */
	OMAP_OPP_DEF("iva", false,  265000000, 1188000),
	/* IVA OPP3 - OPP-Turbo */
	OMAP_OPP_DEF("iva", false, 332000000, 1300000),
	/* DSP OPP1 - OPP50_98 */
	OMAP_OPP_DEF("dsp", true, 232800000, 1011000),
	...
	OMAP_OPP_DEF("dsp", true, 232800000, 1013000),
	/* DSP OPP2 - OPP100 */
	OMAP_OPP_DEF("dsp", false, 465600000, 1188000),
	/* DSP OPP3 - OPPTB */
	OMAP_OPP_DEF("dsp", false, 498000000, 1300000),
	/* ABE OPP - OPP50_98 */
	OMAP_OPP_DEF("omap-aess-audio", true, 49000000, 1011000),
	...
	OMAP_OPP_DEF("omap-aess-audio", true, 98300000, 1013000),
	/* ABE OPP2 - OPP100 */
	OMAP_OPP_DEF("omap-aess-audio", false, 196600000, 1188000),
	/* ABE OPP3 - OPPTB */
	OMAP_OPP_DEF("omap-aess-audio", false, 196600000, 1300000),
	/* L3 OPP1 - OPP50 */
	OMAP_OPP_DEF("l3_main_1", true, 100000000, 1025000),
	...
	OMAP_OPP_DEF("emif1", true, 400000000, 1025000),
	/*EMIF1 OPP2 - OPP100 */
	OMAP_OPP_DEF("emif1", false, 800000000, 1125000),
	/*EMIF2 OPP1 - OPP50 */
	OMAP_OPP_DEF("emif2", true, 400000000, 1025000),
	/*EMIF2 OPP2 - OPP100 */
	OMAP_OPP_DEF("emif2", false, 800000000, 1125000),
	/* CAM FDIF OPP1 - OPP50 */
	OMAP_OPP_DEF("fdif", true, 64000000, 1025000),
	/* CAM FDIF OPP2 - OPP100 */
	OMAP_OPP_DEF("fdif", false, 128000000, 1125000),
	/* SGX OPP1 - OPP50 */
	OMAP_OPP_DEF("gpu", true, 153600000, 1025000),
	/* SGX OPP2 - OPP100 */
	OMAP_OPP_DEF("gpu", false, 307200000, 1125000),
	/* HSI OPP1 - OPP50 */
	OMAP_OPP_DEF("hsi", true, 96000000, 1025000),
	/* HSI OPP2 - OPP100 */
	OMAP_OPP_DEF("hsi", false, 96000000, 1125000),
};
...
#define DPLL_PER_M3_OPP100_RATE		192000000
...
int __init omap4_pm_init_opp_table(void)
{
	...
	else if (bi_powerup_reason() == PU_REASON_CHARGER)
		opp_def = omap44xx_com_opp_def_list;
	else
	...
	if (bi_powerup_reason() == PU_REASON_CHARGER)
		clk_set_rate(dpll_mpu_clk, 300000000);
