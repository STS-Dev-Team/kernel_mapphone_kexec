...
static struct omap_hwmod_opt_clk dss_opt_clks[] = {
	{ .role = "sys_clk", .clk = "dss_sys_clk" , .flags = OMAP_DEPENDENT_CLK },
	{ .role = "tv_clk", .clk = "dss_tv_clk" },
	{ .role = "dss_clk", .clk = "dss_dss_clk", .flags = OMAP_DEPENDENT_CLK },
	{ .role = "48mhz_clk", .clk = "dss_48mhz_clk", .flags = OMAP_DEPENDENT_CLK, },
};
