...
static void __init omap_map_sram(void)
{
	...
	printk(KERN_INFO "SRAM: Flushing caches\n");
	flush_cache_all();
	printk(KERN_INFO "SRAM: Clearing SRAM 0x%08lx 0x%08lx\n", omap_sram_base + SRAM_BOOTLOADER_SZ, omap_sram_size - SRAM_BOOTLOADER_SZ);
	/*
...
//	memset((void *)omap_sram_base + SRAM_BOOTLOADER_SZ, 0,
 //	       omap_sram_size - SRAM_BOOTLOADER_SZ);
	...
	printk(KERN_INFO "SRAM: Clear complete\n");
}
