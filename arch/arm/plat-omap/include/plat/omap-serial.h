...
struct omap_uart_port_info {
	...
	void			(*board_wake_peer)(struct uart_omap_port *up);
	void			(*board_uart_probe)(struct uart_omap_port *up);
	void			(*board_uart_remove)(struct uart_omap_port *up);
