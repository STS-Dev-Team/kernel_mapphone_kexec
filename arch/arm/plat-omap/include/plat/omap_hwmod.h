...
/* omap_hwmod_opt_clks.flags bits */
#define OMAP_DEPENDENT_CLK		(1 << 0)
 ...
 * @flags: (see omap_hwmod_opt_clks.flags macros above)
 *
 ...
 *     This is needed by device like DSS that require optional clocks enabled
