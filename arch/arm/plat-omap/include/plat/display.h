...
enum omap_dss_edid_timing_mode {
	OMAP_DSS_EDID_TIMING_MODE_VESA = 0,
	OMAP_DSS_EDID_TIMING_MODE_CEA,
};

enum omap_dss_edid_timing_vesa {
	OMAP_DSS_EDID_TIMING_VESA_640x480_60Hz       = 0x04,
	OMAP_DSS_EDID_TIMING_VESA_800x600_60Hz       = 0x09,
	OMAP_DSS_EDID_TIMING_VESA_848x480_60Hz       = 0x0E,
	OMAP_DSS_EDID_TIMING_VESA_1024x768_60Hz      = 0x10,
	OMAP_DSS_EDID_TIMING_VESA_1280x768_60Hz      = 0x16,
	OMAP_DSS_EDID_TIMING_VESA_1280x800_60Hz      = 0x1C,
	OMAP_DSS_EDID_TIMING_VESA_1280x960_60Hz      = 0x20,
	OMAP_DSS_EDID_TIMING_VESA_1280x1024_60Hz     = 0x23,
	OMAP_DSS_EDID_TIMING_VESA_1360x768_60Hz      = 0x27,
	OMAP_DSS_EDID_TIMING_VESA_1400x1050_60Hz     = 0x29,
	OMAP_DSS_EDID_TIMING_VESA_1400x1050_60Hz_HPC = 0x2A, /* Higher PClk */
	OMAP_DSS_EDID_TIMING_VESA_1440x900_60Hz      = 0x2F,
	OMAP_DSS_EDID_TIMING_VESA_1680x1050_60Hz     = 0x39,
	OMAP_DSS_EDID_TIMING_VESA_1680x1050_60Hz_HPC = 0x3A, /* Higher PClk */
	OMAP_DSS_EDID_TIMING_VESA_1366x768_60Hz      = 0x51,
	OMAP_DSS_EDID_TIMING_VESA_1920x1080_60Hz     = 0x52,
};

enum omap_dss_edid_timing_cea {
	OMAP_DSS_EDID_TIMING_CEA_640x480_60Hz       = 1,
	OMAP_DSS_EDID_TIMING_CEA_720x480P_60Hz      = 2,
	OMAP_DSS_EDID_TIMING_CEA_720x480P_60Hz_WIDE = 3,  /* Wide, 16:9 */
	OMAP_DSS_EDID_TIMING_CEA_1280x720P_60Hz     = 4,
	OMAP_DSS_EDID_TIMING_CEA_1920x1080I_60Hz    = 5,
	OMAP_DSS_EDID_TIMING_CEA_720x480I_60Hz      = 6,
	OMAP_DSS_EDID_TIMING_CEA_720x480I_60Hz_WIDE = 7,  /* Wide, 16:9 */
	OMAP_DSS_EDID_TIMING_CEA_1920x1080P_60Hz    = 16,
	OMAP_DSS_EDID_TIMING_CEA_720x576P_50Hz      = 17,
	OMAP_DSS_EDID_TIMING_CEA_720x576P_50Hz_WIDE = 18, /* Wide, 16:9 */
	OMAP_DSS_EDID_TIMING_CEA_1280x720P_50Hz     = 19,
	OMAP_DSS_EDID_TIMING_CEA_1920x1080I_50Hz    = 20,
	OMAP_DSS_EDID_TIMING_CEA_720x576I_50Hz      = 21,
	OMAP_DSS_EDID_TIMING_CEA_720x576I_50Hz_WIDE = 22, /* Wide, 16:9 */
	OMAP_DSS_EDID_TIMING_CEA_1920x1080P_50Hz    = 31,
};
...
int dsi_vc_write(enum omap_dsi_index lcd_ix, int channel,
		u8 data_type, u8 *data, int len);
...
struct omap_ovl2mgr_mapping{
	u8 overlay_idx;
	u8 overlay_mgr;
}; /* stores the overlay and manager mapping from panel data */
...
struct omap_dss_board_info {
	...
	int ovl2mgr_mapping_cnt;
	/* Get the board panel data to map overlay with its respective mgr */
	struct omap_ovl2mgr_mapping ovl2mgr_mapping[10];
};
...
struct omap_video_timings {
	...
	u8  sp;		/* Sync polarity, H = bit 0, V = bit 1 */
	u16 w;		/* width of display in mm */
	u16 h; 		/* height of display in mm */
};
...
struct omap_writeback {
	...
	void (*get_wb_info)(struct omap_writeback *wb,
        ...
        // Flag to indicate that one of the sources connected to WB
        // has updated, and WB should be triggered
        bool triggered;
        // Flag to indicate if WB is currently in progress on a
        // previous frame
        bool in_progress;
        // Flag to indicate if there is a buffer available to
        // execute the WB pipe
...
struct omap_dss_device {
	...
	union {
		...
		struct {
			...
			enum omap_dsi_xfer_mode xfer_mode;
		...
		struct {
			enum omap_dss_edid_timing_mode default_mode;
			int default_code;
...
struct omap_dss_driver {
	...
	int (*hs_mode_timing)(struct omap_dss_device *dssdev);
...
/*HDMI specific */
	...
	int (*set_edid_timing)(struct omap_dss_device *dssdev,
			enum omap_dss_edid_timing_mode mode, int code);
	int (*hpd_enable)(struct omap_dss_device *dssdev, bool enable);
...
int omapdss_dsi_enable_te(struct omap_dss_device *dssdev,
			bool enable, enum omap_dsi_te_type type);
