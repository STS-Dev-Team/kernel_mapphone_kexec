...
#ifdef CONFIG_MUDFLAP
extern void *kmem_cache_alloc_notrace_realsize(struct kmem_cache *cachep,
						gfp_t flags,
...
#ifdef CONFIG_MUDFLAP
static __always_inline  void *kmem_cache_alloc_notrace_realsize(
...
#ifdef CONFIG_MUDFLAP
		ret = kmem_cache_alloc_notrace_realsize(cachep, flags, size);
#else
