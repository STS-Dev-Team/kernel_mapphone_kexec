...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_MOT_HOTPLUG)
extern struct cpufreq_governor cpufreq_gov_mot_hotplug;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_mot_hotplug)
#endif
